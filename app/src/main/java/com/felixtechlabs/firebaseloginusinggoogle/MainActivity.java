                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(MainActivity.this, "Sucees login using google", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(MainActivity.this, "Sorry Authentication falied", Toast.LENGTH_SHORT).show();
